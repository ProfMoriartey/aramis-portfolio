    ...
    >
      ...
      <div className="max-w-sm flex flex-col">
        ...
        >
          <Link
            href="#contact"
            className="group bg-gray-900 text-white mr-2.5 px-7 py-3 flex items-center gap-4 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition"
            onClick={() => {
